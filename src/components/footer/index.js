        ...
        <div>
          <h2>Built with React<img className='react-logo' alt='ReactLogo' src={ReactLogo}></img> </h2>
            ...
            <a href="mailto:austin.coding@gmail.com"><img className='social-icons white-icons' alt='email-logo' src={Email}></img></a> 
                    ...
                    <a href="https://docs.google.com/document/d/1U7qVsWVwF4Z0S1K0xie9Jdhnupf-XNPezYCLKh90JfE/edit?usp=sharing" target={'_blank'} rel="noreferrer"><img className='social-icons' alt='resume icon' src={Resume}></img></a>
                    <a href="https://github.com/austindavis95" target={'_blank'} rel="noreferrer"><img className='social-icons white-icons' alt='github logo' src={Github}></img></a>
                    <a href="https://open.spotify.com/user/1214582229" target={'_blank'} rel="noreferrer"><img className='social-icons white-icons' alt='spotify logo' src={Spotify}></img></a>
                    <a href=" https://www.linkedin.com/in/austin-davis-8570a6239/" target={'_blank'} rel="noreferrer"><img className='social-icons' alt='linkedin icon' src={Linkedin}></img></a>
